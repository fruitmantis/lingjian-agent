...
const errorStageLabels: Record<string, string> = {
  partner_match: "项目找伙伴", partner_data: "伙伴数据读取", demand_profile: "需求画像",
    ...
    <>
      <section className="card toolbar-card">
        ...
        <form onSubmit={event => { event.preventDefault(); void load(1); }} className="inline-search task-search">
          ...
          <select value={taskType} onChange={event => setTaskType(event.target.value)} aria-label="任务类型"><option value="">全部类型</option><option value="partner_match">项目找伙伴</option><option value="development_plan">能力发展</option></select>
