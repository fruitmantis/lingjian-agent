...
export default function PartnerDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="page">
      <div className="page-heading-row"><div><p className="eyebrow">Partner Detail</p><h1>{partner.name}</h1><p className="lead">{partner.intro || "暂无伙伴简介"}</p></div><Link href="/partners" className="secondary-btn">返回伙伴洞察</Link></div>
      ...
      <div className="notice-neutral">伙伴原始资料由平台管理员统一维护，普通用户侧仅展示经过整理的正式信息。</div>
    </main>
  );
}
