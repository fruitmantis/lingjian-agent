...
type Partner = { id: string; name: string; intro: string | null; capabilities: string | null; service_areas: string | null; industries: string | null; ai_profile: string | null; status: "active" | "disabled" };
...
export default function AdminPartnerDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  async function generateProfile() {
    setBusy(true); const response = await apiFetch(`/partners/${id}/profile`, { method: "POST" });
