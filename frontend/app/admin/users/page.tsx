...
type UserApplication = {
  ...
  contact: string | null; employee_id: string | null; email: string | null; reason: string | null; status: "pending" | "approved" | "rejected";
