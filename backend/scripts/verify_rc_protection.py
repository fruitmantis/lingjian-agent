...
manifest=json.loads((ROOT/'.isolation/evidence/rc-stable-start.json').read_text())
...
assert git(ROOT,'rev-parse','phase-c-accepted-20260906-351489c')=='351489c3d3c89899837930bd7aab01fe61f4a52a'
assert git(ROOT,'rev-parse','phase-d-engineering-accepted-20260906-78e70ac')=='78e70ac0f3e258d3f4ce51a8ca60455a8887028d'
assert not git(ROOT,'diff','78e70ac0f3e258d3f4ce51a8ca60455a8887028d','--','artifacts/enablement-phase-d')
processes={}
...
# The only stable HTTP request allowed by the RC instruction.
...
output=ROOT/'artifacts/enablement-rc/protection-verification.json';output.write_text(json.dumps(result,ensure_ascii=False,indent=2));print(json.dumps(result,ensure_ascii=False))
